...
def build_pipeline(
    ...
    tts = get_tts_handler(module_kwargs, stop_event, lm_response_queue, send_audio_chunks_queue, should_listen, parler_tts_handler_kwargs, melo_tts_handler_kwargs, chat_tts_handler_kwargs, facebook_mms_tts_handler_kwargs, kokoro_tts_handler_kwargs)
...
def get_tts_handler(module_kwargs, stop_event, lm_response_queue, send_audio_chunks_queue, should_listen, parler_tts_handler_kwargs, melo_tts_handler_kwargs, chat_tts_handler_kwargs, facebook_mms_tts_handler_kwargs, kokoro_tts_handler_kwargs):
    if module_kwargs.tts == "parler":
        ...
        raise ValueError("The TTS should be either parler, melo, chatTTS, facebookMMS, or kokoro")
